...
public class NotificationWorkerRestControllerTest {
    ...
    @Test
    public void testAcknowledgeNotificationAndWork() throws Exception {
        //act and assert
        this.mockMvc.perform(MockMvcRequestBuilders.post("/api/notification")
